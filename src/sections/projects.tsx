...
import { my_projects } from 'src/temp/projects';

const styles = {
  project_title: "font-space-grotesk-700 text-[24px] mt-8 mb-2 ml-1 text-[#333333]",
  project_container: "flex flex-wrap gap-6 mb-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3",
};
